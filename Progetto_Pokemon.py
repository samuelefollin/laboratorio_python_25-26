...
if scelta == str(1):                                                                         #se l'utente sceglie di attaccare
    ...
    if selezionatore.hp > 0:
        ...
        if sfera == str(1):                                                                  #creo tre diversi oggetti Pokeball, verrà usato uno solo dei tre
            sfera = Pokeball("Pokeball", 0)
        elif sfera == str(2):
            sfera = Pokeball("Megaball", 10)
        elif sfera == str(3):
            sfera = Pokeball("Ultraball", 20)
        sfera.lancia()
